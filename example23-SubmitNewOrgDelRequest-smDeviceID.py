...
action = 'delete'
# set IDENTIFIER_TYPE to smDevice as defined in config.ini
identifier_type = config['DELETE-AND-RESTRICT-DATA']['IDENTIFIER_TYPE_SMDEVICE']
# set IDENTIFIER to an actual smDevice value in config.ini
identifier_value = config['DELETE-AND-RESTRICT-DATA']['IDENTIFIER_VALUE_SMDEVICE']
