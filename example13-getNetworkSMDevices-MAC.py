...
# see getNetworkSMDevicesForKey function in PIICalls module for details and arguments
...
MyNetworkSMDevices = PIICalls.getNetworkSMDevicesForKey(apikey, networkid, identifier_type, identifier_value)
print(json.dumps(MyNetworkSMDevices, indent=4, sort_keys=False))